...
<div id="sidebar">
    <a href="#" class="visible-phone"><i class="icon icon-home"></i> aaaaaaaaaa</a>
    <ul>
        <li class="active"><a href="index.html"><i class="icon icon-home"></i> <span></span></a></li>
        <li class="submenu">
...
<div id="style-switcher">
    ...
    <a href="#red-green" style="background-image: url('../static/img/demo/red-green.png');background-repeat: no-repeat;"></a>
</div>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="alert alert-info">
                    ...
                    <a href="#" data-dismiss="alert" class="close">¡Á</a>
                </div>
                        ...
                        <ul class="recent-posts">
                            <li>
                                <div class="user-thumb">
                                    <img width="40" height="40" alt="User" src="../static/img/demo/av2.jpg">
                                </div>
                            ...
                            <li>
                                <div class="user-thumb">
                                    <img width="40" height="40" alt="User" src="../static/img/demo/av3.jpg">
                                </div>
                                <div class="article-post">
                            ...
                            <li>
                                <div class="user-thumb">
                                    <img width="40" height="40" alt="User" src="../static/img/demo/av1.jpg">
                                </div>
                                <div class="article-post">
